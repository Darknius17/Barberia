...
<body>
  ...
  <form action="{{route('reserva.actualizar', $reserva->id)}}" method="POST">
    @csrf
    @method('put')
    <div class="container">
            <div> <h2>Actualizar Hora </h2> </div>
...
<div class="mb-3">
  ...
  <div class="mb-3" hidden>
    <label for="exampleFormControlInput1" class="form-label col-2">id_agenda</label>
    <input type="text" class="form-group" id="exampleFormControlInput1" placeholder="" name="id_agenda" value="{{$reserva->id_agenda}}">
    @error('comentario')
    <div class="alert alert-danger" role="alert">
      *{{$message}}
    </div>
